/***************************************************************************
 *   ex17.c                                   Version 20220501.180901      *
 *                                                                         *
 ...
 * $gcc ex17.c -o ex17.x -Wall -Wextra -g -O0 -DDEBUG=1
...
#define VERSION "20220501.180901" /* Version Number (string) */
#endif
...
int main(void)
{
    ...
    No *topo = NULL;//criancao ponteiro "cabeca"
    char operacoes[100];//operacoes digitadas pelo usuario
    printf("Digite em RPN os numeros e operacoes!\n");
    printf("Conforme o exemplo: 2 5 3 + * = 2 * (5 + 3)\n\n");

    printf("O resultado das operacoes e': %f\n",  resolver_expressao(fgets(operacoes, 100, stdin), topo));//chamado e print do valor
