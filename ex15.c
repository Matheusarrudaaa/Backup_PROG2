/***************************************************************************
 *   ex15.c                                   Version 20220430.161700      *
 *                                                                         *
 *   "Bineco", o genio esperto                                             *
 ...
 * $gcc ex15.c -o ex15.x -Wall -Wextra -g -O0 -DDEBUG=1
...
#define VERSION "20220430.161700" /* Version Number (string) */
#endif
...
printf("Para sair do jogo Digite os comando Ctrl + C\n\n");
...
{
    IFDEBUG("help()");
    printf("%s - %s\n", "ex15", "Brief description Bineco, o genio esperto");
    printf("\nUsage: %s\n\n", "ex15");
