/***************************************************************************
 *   ex10.c                                   Version 20220409.210303      *
 *                                                                         *
 *  inversao de string recursiva                                           *
...
#define VERSION "20220409.210303" /* Version Number (string) */
#endif
...
int main(void)
{
    ...
    fgets(nome, 50, stdin);
    //chamado da funcao recursiva
    invert(nome, aux, strlen(nome) - 1);
    //print do nome invertido pela funcao recursiva
...
{
    IFDEBUG("help()");
    printf("%s - %s\n", "ex10", "inversao de string recursiva");
    printf("\nUsage: %s\n\n", "ex10");
    /* add more stuff here */
